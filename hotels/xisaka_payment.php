...
<head>
    ...
    <title>Complete Payment - Xisaka Guest House</title>
...
<body>
    <div class="payment-container">
        ...
        <div class="booking-summary">
            ...
            <?php if ($booking['addonTotal'] > 0): ?>
            <div class="summary-row">
                <span class="summary-label">Add-ons:</span>
                <span class="summary-value">R<?php echo number_format($booking['addonTotal'], 2); ?></span>
            </div>
            <?php endif; ?>
        </div>
        ...
        paypal.Buttons({
            ...
            onApprove: function(data, actions) {
                return actions.order.capture().then(function(details) {
                    ...
                    return fetch('xisaka_payment_success.php', {
                        method: 'POST',
                        headers: {
                    ...
                    .then(data => {
                        if (data.success) {
                            window.location.href = 'xisaka-success.php?payment=success&booking_id=<?php echo $booking['bookingId']; ?>';
                        } else {
