...
echo "Total Amount ZAR: " . $booking['totalAmountZAR'] . " | ";
echo "Total Amount USD: " . $booking['totalAmountUSD'] . " | ";
...
<head>
    ...
    <title>Complete Payment - Vahlavi Guest House</title>
...
<body>
    <div class="payment-container">
        ...
        <div class="booking-summary">
            ...
            <?php if ($booking['packageTotal'] > 0): ?>
            <div class="summary-row">
                <span class="summary-label">Packages:</span>
                <span class="summary-value">R<?php echo number_format($booking['packageTotal'], 2); ?></span>
            </div>
            <?php endif; ?>
        </div>
        ...
        paypal.Buttons({
            ...
            onApprove: function(data, actions) {
                return actions.order.capture().then(function(details) {
                    ...
                    return fetch('vahlavi_payment_success.php', {
                        method: 'POST',
                        headers: {
                    ...
                    .then(data => {
                        if (data.success) {
                            window.location.href = 'vahlavi-success.php?payment=success&booking_id=<?php echo $booking['bookingId']; ?>';
                        } else {
